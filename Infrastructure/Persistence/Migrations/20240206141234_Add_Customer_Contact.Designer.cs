...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240206141234_Add_Customer_Contact")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Application.Common.DBSupports.SPColumnTypes", b =>
                {
                    ...
                    b.ToTable("SPColumnTypes", null, t =>
                        {
            ...
            modelBuilder.Entity("Application.Common.DBSupports.SPSingleValueQueryResultString", b =>
                {
                    ...
                    b.ToTable("SPSingleValueQueryResultString", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Notifications.Device", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Webhook.WebHook", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("HookEventTypes")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<DateTimeOffset?>("LastTriggerAtUTC")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("Domain.Entities.Webhook.WebHookHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Webhook.WebHookRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.Customers.Customer", b =>
                {
                    b.HasOne("Domain.Entities.Contacts.Contact", "OtherContact")
                        .WithMany("OtherContactCustomer")
                        .HasForeignKey("OtherContactId");

                    b.HasOne("Domain.Entities.Contacts.Contact", "PrimaryContact")
                        .WithMany("PrimaryContactCustomer")
                        .HasForeignKey("PrimaryContactId");

                    b.Navigation("OtherContact");
            ...
            modelBuilder.Entity("Domain.Entities.Webhook.WebHookHeader", b =>
                {
                    b.HasOne("Domain.Entities.Webhook.WebHook", "WebHook")
                        .WithMany("Headers")
            ...
            modelBuilder.Entity("Domain.Entities.Contacts.Contact", b =>
                {
                    b.Navigation("OtherContactCustomer");

                    b.Navigation("PrimaryContactCustomer");
                });
